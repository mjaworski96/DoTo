...
public interface ProjectService {
    ...
    ProjectStateChange modifyState(int projectId, ProjectStateChange newState, String token) throws UserNotFoundException, ForbiddenException, ProjectNotFoundException;
}
